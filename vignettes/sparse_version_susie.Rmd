...
`profvis` shows that for a 1000 by 10000 matrix, dense version susie needs 13400ms and sparse version susie needs 8530ms. We can also take a close look at those profiles for each function and discuss which step could be improved. 
```{r}
profvis({
