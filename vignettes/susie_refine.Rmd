...
```{r}
fitted <- susie_suff_stat(XtX = dat$XtX, Xty = dat$Xty, yty = dat$yty, n = dat$n)
...
```{r}
fitted_refine <- susie_suff_stat(XtX = dat$XtX, Xty = dat$Xty, yty = dat$yty, n = dat$n, refine=TRUE)
