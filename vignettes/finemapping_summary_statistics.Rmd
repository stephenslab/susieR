...
## Impact of sample size specification

We require sample size input for summary statistics applications. Mis-specification of sample size will have an impact on the result. For example here we use a small sample size $N=50$,
...
There is one credible set that captures the true effect 773.
