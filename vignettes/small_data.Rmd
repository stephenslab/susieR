...
This is vignette mimic the example from  
[Denault et al paper](https://doi.org/10.1101/2025.05.16.654543).

The simulated data are  based on normalized gene expression and normalized SNP data, and the goal is to finemap
genetic variants for expression (eQTLs). Note that in this example the ground truth in unknown.



To reproduce this example you need to install the latest version of SuSiE
```{r eval=FALSE }
...
The results are more plausible as this version of SuSiE only outputs two
CSs:
