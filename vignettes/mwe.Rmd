...
This fits a sparse linear regression model with up to $L$ non-zero
effects. Generally there is no haarm in over-stating $L$ (that is, the
method is pretty robust to overfitting) except that computation will
grow as $L$ grows.
