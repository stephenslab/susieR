...
Here we apply SuSiE to perform 0th order trend filtering in some simple simulated examples. 

First we set up $X$ as the matrix with step functions in the columns:
```{r}
n=1000
...
Now simulate some data where $\mu$ is a step function with four steps. Here the regression is truly sparse and susie should do well.
```{r}
library(susieR)
set.seed(1)
