...
This strategy has a decent performance when computing both $\boldsymbol{\widetilde{X}b}$ and $\boldsymbol{\widetilde{X}^Ty}$, compared to simple matrix multiplication `%*%`.
