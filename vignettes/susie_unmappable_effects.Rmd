...
SuSiE-ash finds 3 credible sets, with only a single false positive. It
successfully:

1. **Reduces the false positives** that plagued standard SuSiE (from 4 to 1)
2. **Retains more true signals** than SuSiE-inf, which was too aggressive
