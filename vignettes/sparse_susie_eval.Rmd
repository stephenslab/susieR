...
In this minimal example, we have shown that the revised version of SuSiE can reduce computation time by around $35\%$, even if the input matrix is a dense matrix, and further reduce computation time $5\%$ more given the input matrix is a sparse matrix. It is also obvious that the revised version takes less memory. We provide line profiling below so that people who are interested could improve the work as well.  
