...
#' coef(res)
#' @export
susie_ss = function(XtX,Xty,L=10,prior_variance=0.2,residual_variance=NULL,estimate_prior_variance = FALSE, max_iter=100,s_init = NULL, verbose=FALSE, intercept=0, tol = 1e-4){
  # Check input XtX.
  ...
  if(!is.null(s_init)){
    ...
    if(is.null(residual_variance)){
      residual_variance = readline(prompt="What is the variance of Y?")
    }
