...
test_that("single_effect_regression_rss agrees with previous version", with(simulate(200, 500), {
  ...
  s = single_effect_regression_rss(z, R, residual_variance = s$sigma2, optimize_V = "none")
