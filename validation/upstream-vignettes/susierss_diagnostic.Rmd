...
This vignette focuses on diagnosing inconsistencies such as allele
coding artifacts. For model-based ways to account for finite or
mismatched LD reference panels in fine mapping, see
[this vignette](rss_mismatch.html).
