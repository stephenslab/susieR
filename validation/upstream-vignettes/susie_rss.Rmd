...
been removed. For out-of-sample LD reference panels and the
`R_finite` and `R_mismatch` options, see
[this vignette](rss_mismatch.html).

```{r first-comparison, fig.height=3.5, fig.width=3}
res1 <- susie_additive(X,y,L = 10)
...
res1 <- susie_additive(scale(X),scale(y),L = 10)
res2 <- susie_rss(bhat = ss$betahat,shat = ss$sebetahat,R = R,n = n,
